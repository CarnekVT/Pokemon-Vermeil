...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/msys64/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64")
  ...
  CONFIG["configure_args"] = " '--prefix=/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64' '--prefix=C:/msys64/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64' '--enable-install-static-library' '--disable-install-doc' '--without-ext=openssl,readline,dbm,gdbm,win32ole' '--with-static-linked-ext' '--disable-rubygems' '--without-gmp' 'CC=gcc' 'CFLAGS=-std=gnu99 -I/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64/include -O3' 'LDFLAGS=-L/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64/lib'"
  ...
  CONFIG["DLDFLAGS"] = "-L/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64/lib -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -L/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64/lib -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-std=gnu99 -I/tmp/v25_mkxp_next_phase1_build/mkxp-z-v25-next/windows/build-mingw64/include -O3"
