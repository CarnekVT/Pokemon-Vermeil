...
class Mode7Renderer
    ...
    faces.each do |mf|
      begin
        ...
        pseudo = {
          ...
          # Streamed mesh rows do not duplicate instance-level priority. Recover
          # the authored flag without changing culling or projection semantics.
  ...
  def build_nds_geometry_objects
    ...
    # Preserve the instance metadata used by the pre-mk priority fixes.  This is
    # only an identity lookup; visibility remains PATCH3's proven culling path.
