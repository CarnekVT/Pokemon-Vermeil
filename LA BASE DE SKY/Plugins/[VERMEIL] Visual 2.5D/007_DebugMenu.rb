...
# --- Opcion del jugador (antes 008_Options.rb) ---
# Activa/desactiva la camara 2.5D desde el menu de Opciones. Solo se muestra
# si Config::PLAYER_SWITCH apunta a un switch libre.
