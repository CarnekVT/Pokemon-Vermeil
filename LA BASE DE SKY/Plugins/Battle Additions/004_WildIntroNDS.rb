...
#   MOVE_TIME    = 12
#   REVEAL_SPEED = 1
#   # Settings for intro customization
#   REMOVE_BASES = true   # Set true to omit base sprites during intro
#   ZOOM_FACTOR  = 1.5     # Multiply zoom values (e.g., 200 -> 200*ZOOM_FACTOR)
...
#   def addSprite(sprite, origin = PictureOrigin::TOP_LEFT)
#     super
#   end

#   # Class method fallback for compatibility with calls made on the class
#   def self.addNewSprite(x, y, name, origin = PictureOrigin::TOP_LEFT)
#     dummy = new({}, nil, nil)
#     dummy.addNewSprite(x, y, name, origin)
#   end

#   def self.addSprite(sprite, origin = PictureOrigin::TOP_LEFT)
#     dummy = new({}, nil, nil)
#     dummy.addSprite(sprite, origin)
#   end
...
#           unless VermeilWildIntroNDS::REMOVE_BASES
# if false # duplicate base handling removed
...
#     # Hide base sprites if configured
#     if VermeilWildIntroNDS::REMOVE_BASES
...
#     end
#     idx = 1
#     while @sprites && @sprites["trainer_#{idx}"]
...
#     zoomStart = (200 * VermeilWildIntroNDS::ZOOM_FACTOR).to_i
#     zoomEnd   = (100 * VermeilWildIntroNDS::ZOOM_FACTOR).to_i
...
#     else
#       # Si la base fue eliminada por REMOVE_BASES, usamos las coordenadas matemáticas
#       bx, by = Battle::Scene.pbBattlerPosition(1)
#       focusX = bx
#       focusY = by
#     end
...
#     if @battle.respond_to?(:showAnims) && @battle.showAnims
#       @battle.sideSizes[1].times do |i|
#         idxBattler = (2 * i) + 1
