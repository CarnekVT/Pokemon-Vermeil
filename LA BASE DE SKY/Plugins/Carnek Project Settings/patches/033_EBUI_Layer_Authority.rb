...
# dynamically by BSS. Uses prepend + super only; no alias chain. Prepends chain
# via `super` in any load order, so no SystemStackError is possible (the flat
# alias_method version captured whatever prepended module was on top and that
# module's `super` bounced back into the alias). Justified exception to R5 in a
# plugin ecosystem that is already prepend-based.
#===============================================================================
