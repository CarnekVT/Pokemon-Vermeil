...
class PokemonSummary_Scene
  ...
  def drawPageAllStats
    ...
    textpos = [
      ...
      [sprintf("%d", @pokemon.ev[:HP]), HP_EV_X, HP_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
      ...
      [sprintf("%d", @pokemon.ev[:ATTACK]), ATK_EV_X, ATK_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
      ...
      [sprintf("%d", @pokemon.ev[:DEFENSE]), DEF_EV_X, DEF_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
      ...
      [sprintf("%d", @pokemon.ev[:SPECIAL_ATTACK]), SPA_EV_X, SPA_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
      ...
      [sprintf("%d", @pokemon.ev[:SPECIAL_DEFENSE]), SPDEF_EV_X, SPDEF_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
      ...
      [sprintf("%d", @pokemon.ev[:SPEED]), SPEED_EV_X, SPEED_EV_Y, :center, COLOR_NUMERO_BASE, COLOR_NUMERO_SOMBRA],
