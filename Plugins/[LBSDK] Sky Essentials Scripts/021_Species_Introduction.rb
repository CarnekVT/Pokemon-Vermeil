...
# species in a border together with a message containing the name and kind, plays
# its cry and marks it as seen in the Pokédex. Good to make the starter selection
# event. 
#
#== INSTALLATION ===============================================================
#
