...
#===============================================================================
# Added to track whether Pokemon has already received IV boost due to Trading Charm.
class Pokemon
  ...
  def pbChoosePokemonFromPC(wanted, ableProc)
    ...
    loop do
      ...
      if selected.nil?
        ...
        helptext = _INTL("You have chosen {1}.", pokemon.name)
        ...
        when 0   # Select
          if pokemon.species == wanted
            ...
            pbMessage(_INTL("This is not the Pokémon I'm looking for!"))
          end
        when 1 # Summary
