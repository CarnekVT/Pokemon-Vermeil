...
ItemHandlers::UseText.add(:INFREPEL, proc { |item| next _INTL("Deactivate")})
ItemHandlers::UseText.add(:INFREPELOFF, proc { |item| next _INTL("Activate")})
